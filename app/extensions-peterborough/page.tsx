...
export const metadata: Metadata = {
  title: "House Extensions in Peterborough | RPV Construction",
  description: "RPV Construction are specialist home extension builders in Peterborough. Rear extensions, loft conversions, double-storey extensions and full refurbishments. Free quotes.",
};
  ...
  return (
    <>
      <div style={{ padding: "120px 24px 60px", background: "#1a3350", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 900, color: "#fff", marginTop: 12 }}>Extensions Peterborough</h1>
        <p style={{ color: "#94a3b8", maxWidth: 600, margin: "16px auto 0", lineHeight: 1.7 }}>RPV Construction are specialist home extension builders in Peterborough. Rear extensions, loft conversions, double-storey extensions and full refurbishments. Free quotes.</p>
      </div>
