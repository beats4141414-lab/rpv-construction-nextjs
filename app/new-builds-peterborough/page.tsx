...
export const metadata: Metadata = {
  title: "New Build Homes in Peterborough | RPV Construction",
  description: "RPV Construction build bespoke new homes in Peterborough. Fully managed new build construction from groundworks to completion. Free quotes.",
};
  ...
  return (
    <>
      <div style={{ padding: "120px 24px 60px", background: "#1a3350", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 900, color: "#fff", marginTop: 12 }}>New Builds Peterborough</h1>
        <p style={{ color: "#94a3b8", maxWidth: 600, margin: "16px auto 0", lineHeight: 1.7 }}>RPV Construction build bespoke new homes in Peterborough. Fully managed new build construction from groundworks to completion. Free quotes.</p>
      </div>
      <section style={{ padding: "80px 24px", background: "#152a42" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: 32 }}>
            <Link href="/services/new-builds" style={{ color: "#74be43", textDecoration: "none", fontWeight: 600, fontSize: "0.9rem" }}>← View full service details</Link>
          </div>
        </div>
      </section>
    </>
